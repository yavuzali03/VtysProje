...
export const Details = ({route}) => {
    ...
    const position = positions.find(
      (item) => item.value === playerData.profile.position.main
    )?.label || "Bilinmiyor";
  ...
  return (
    <ScrollView style={{backgroundColor : "#1B212E" }}>
      <View style={{flex : 1, justifyContent: "flex-start" , alignItems :"center" , backgroundColor : "#1B212E"}}>
          <SearchBar></SearchBar>
          <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#1ef876', '#15ae53', '#0c632f']} style={styles.linearGradient}>

                  <Image source={{uri : playerData.profile.imageURL}} style={{height : width*0.24 , width: width*0.18 , backgroundColor :"gray" , borderRadius : 16}}></Image>
          ...
          <View style={[styles.borderView , {height: width*0.3}]}>
              <View style={[styles.insideView , {height: width*0.285}]}>
                  <Text style={{fontSize : 50 , color : "white" , fontWeight : "bold"}}>{playerData.profile.marketValue}</Text>
              </View>
          </View>
              ...
              <View style={[styles.insideView , {flexDirection: "column"}]}>
                  ...
                  <View style={styles.infoView}>
                      ...
                      <View style={{justifyContent : "center" , alignItems : "center"}}>
                          ...
                          <Text style={styles.text}>{playerData.profile.placeOfBirth.city}</Text>
                      </View>

                      <View style={{justifyContent : "center" , alignItems : "center"}}>
                          <Image source={require("../assets/VTYSicons/united-nations.png")} style={{width : width*0.1 , height : width*0.1}}></Image>
                          <Text style={styles.text}>{playerData.profile.citizenship}</Text>
                      </View>
                  ...
                  <View style={styles.infoView}>
                      ...
                      <View style={{justifyContent : "center" , alignItems : "center"}}>
                          ...
                          <Text style={styles.text}>{playerData.profile.club.contractExpires}</Text>
                      </View>
